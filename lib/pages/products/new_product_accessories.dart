...
class NewProductAccessoriesPage extends StatelessWidget {
  const NewProductAccessoriesPage({super.key});
    ...
    return Scaffold(
      body: BlocProvider(
        create: (BuildContext context) =>
            ShopCubit()..getNewProductAcceissories(),
